...
export function BookPromo() {
  return (
    <a
      href="https://www.linkedin.com/in/rabin-bam-317ba5160/"
      className="group"
    >
      ...
      <blockquote className="mt-6 border-l border-black/5 pl-4 text-gray-600 dark:border-white/10 dark:text-gray-400">
        <p className="text-[0.8125rem]/5 [hanging-punctuation:first_last]">
          “The story is amazing as per the writter he is mad for those sad
          backstory.”
        </p>
        <p className="mt-3 text-xs">-Rugare Dolas</p>
      </blockquote>
    </a>
  );
}
...
export function CoursePromo() {
  return (
    <div className="group relative">
      ...
      <p className="text-[0.8125rem]/6 font-semibold text-sky-500 dark:text-sky-400">
        5-day mini-course
      </p>
      ...
      <p className="mt-3 text-[0.8125rem]/5 text-gray-600 dark:text-gray-400">
        A short Presented by one of the pioneer AI specialist delivered at your
        inbox right away.
      </p>
      <p className="mt-4">
        <LinkButton href="https://www.linkedin.com/in/roshit-lamichhane-a53820253/">
